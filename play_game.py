...
flags.DEFINE_bool('Debug',False,'production or debug quality')
...
def main(_):
  ...
  #with open('/home/zohair/cc/football/third_party/gfootball_engine/src/menu/ingame/DEBUG.txt', 'w') as file:
    # Write 'True' to the file
  #  file.write(str(FLAGS.Debug))

  #print("Write operation completed.",FLAGS.Debug)
